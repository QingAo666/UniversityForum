  ...
  <div class="topic-page" v-if="topic.data">
    ...
    <div class="topic-main">
      <div class="topic-main-left">
        ...
        <div style="text-align: left; margin: 5px 70px;">
      ...
      <div class="topic-main-right">
        <div class="topic-content" v-html="convertToHtml(topic.data.text)">
        </div>
        <el-divider/>
        ...
        <div style="text-align: right; margin-top: 30px">
          ...
          <interact-button name="点个赞吧" check-name="已点赞" color="pink" :check="topic.like"
                           @check="interact('like','点赞')" style="margin-left: 20px">
            <el-icon><CircleCheck/></el-icon>
          </interact-button>
          <interact-button name="收藏本贴" check-name="已收藏" color="orange" style="margin-left: 20px"
    ...
    <topic-editor :show="edit" @close="edit = false" v-if="topic.data && store.forum.types"
                  :default-type="topic.data.type" :default-title="topic.data.title"
                  :default-text="topic.data.text" submit-button="更新帖子信息" :submit="updateTopic"/>
...
.topic-main{
  ...
  .topic-main-left{
    ...
    padding: 10px;
    text-align: center;
    border-right: solid 3px var(--el-border-color);

  ...
  <div style="text-align: center">
    ...
    <div style="margin: 0 20px" v-if="active === 0">
      <div style="margin-top: 80px">
        ...
        <div style="font-size: 14px; margin-top:10px;color: grey">请输入需要重置密码的电子邮件</div>
      </div>
      <div style="margin-top: 50px">
        <el-form :model="form" :rules="rule" ref="formRef">
          <el-form-item prop="email">
            <el-input v-model="form.email" type="email" placeholder="邮件地址">
              <template #prefix>
      ...
      <div style="margin-top: 30px">
        <span style="font-size: 14px;line-height:15px; color:grey;">想起来了密码？</span>
    ...
    <div style="margin: 0 20px" v-if="active === 1">
      <div style="margin-top: 80px">
        <div style="font-size: 25px;font-weight: bold">重置密码</div>
        <div style="font-size: 14px; margin-top:10px;color: grey">请填写你的新密码，务必牢记，防止丢失</div>
      </div>
      <div style="margin-top: 50px">
        <el-form :model="form" :rules="rule" ref="formRef">
          ...
          <el-form-item prop="repeat_password">
            <el-input v-model="form.repeat_password" maxlength="20" type="password" placeholder="重复密码">
              <template #prefix>
                <el-icon><Lock/></el-icon>
              </template>
            </el-input>
      ...
      <div style="margin-top: 60px;">
        <el-button @click="doReset" type="danger" style="width: 270px" plain>立即重置密码</el-button>
      </div>
    </div>
  </div>
</template>

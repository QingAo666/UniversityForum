...
<template>
  <div class="main-content" v-loading="loading" element-loading-text="正在进入，请稍等...">
      ...
      <el-header class="main-content-header">
        ...
        <div class="user-info">
          <el-popover  placement="bottom" :width="350" trigger="click">
            ...
            <el-empty :image-size="80" description="暂时没有未读信息哦~" v-if="!notification.length"/>
              ...
              <el-sub-menu index="1">
                ...
                <el-menu-item>
                  <template #title>
                    ...
                    海文考研
                    <el-tag style="margin-left: 10px; font-size: small">合作机构</el-tag>
                  </template>
                </el-menu-item>
              </el-sub-menu>
              <el-sub-menu index="2">
                ...
                <el-menu-item>
                  <template #title>
                    ...
                    成绩查询
                    <el-tag type="danger" style="margin-left: 10px; font-size: small;">不可用</el-tag>
                  </template>
                </el-menu-item>
                <el-menu-item>
                  <template #title>
